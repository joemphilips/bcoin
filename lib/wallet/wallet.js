...
class Wallet extends EventEmitter {
   ...
   * The reason this logic is not implemented as PSBT's method is because we
   * must provide whole TX in case input is not witness.
   * @param {PSBT} psbt - psbt to fund.
   * @param {Object} options - takes similar options to `fund()`
  ...
  async createFundedPSBT(options, force, passphrase) {
    ...
    const psbt = PSBT.fromTX(mtx.toTX());
