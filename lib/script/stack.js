...
class Stack {
  ...
  getString(index) {
    const item = this.get(index);
    return item ? Stack.toString(item) : null;
  }
  ...
  setString(index, str) {
    return this.set(index, Stack.fromString(str));
  }

  pushString(str) {
    return this.push(Stack.fromString(str));
  }

  unshiftString(str) {
    return this.unshift(Stack.fromString(str));
  }

  insertString(index, str) {
    return this.insert(index, Stack.fromString(str));
  }
